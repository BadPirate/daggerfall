...
void oedit_disp_val1_menu(struct descriptor_data * d)
{
  ...
  case ITEM_POTION:
    ...
    break;
  case ITEM_MOBSPELL:
    send_to_char("1.  Cast on self\r\n2.  Cast on someone in room\r\n3.  Cast on who mob's fighting\r\nEnter Number: ", d->character);
    break;
  case ITEM_COMBINE:
    send_to_char("VNUM of first obj Required: ", d->character);
    break;
  case ITEM_WEAPON:
...
void oedit_disp_val2_menu(struct descriptor_data * d)
{
  ...
  case ITEM_STAFF:
    ...
    break;
  case ITEM_MOBSPELL:
    send_to_char("1 in ? chance of using : ", d->character);
    break;
  case ITEM_COMBINE:
    send_to_char("VNUM of 2nd object Required: ", d->character);
    break;
  case ITEM_WEAPON:
...
void oedit_disp_val3_menu(struct descriptor_data * d)
{
  ...
  case ITEM_MOBSPELL:
    ...
    break;
  case ITEM_COMBINE:
    send_to_char("VNUM of obj to be created :", d->character);
    break;
  case ITEM_WEAPON:
...
void oedit_disp_val4_menu(struct descriptor_data * d)
{
  ...
  case ITEM_STAFF:
    ...
    break;
  case ITEM_COMBINE:
    send_to_char("1 = Destroyed, 0 = Stays after combine : ", d->character);
    break;
  case ITEM_WEAPON:
